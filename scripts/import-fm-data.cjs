...
const DIVISION_MAP = {
  ...
  'Portuguese Premier League': 'primeira',
  'Portuguese Liga': 'primeira',
  'Liga Portugal': 'primeira',
  'Liga Portugal Bwin': 'primeira',
  'Scottish Premiership': 'spl',
  'cinch Premiership': 'spl',
  'Ladbrokes Premiership': 'spl',
  'Turkish Super League': 'superlig',
  'Turkish Süper Lig': 'superlig',
  'Spor Toto Süper Lig': 'superlig',
  'Greek Super League': 'gsl',
  'Greek Super League 1': 'gsl',
  'Super League Interwetten': 'gsl',
};
...
const CLUBS = [
  ...
  // Eredivisie
  { id: 'ajx', name: 'Ajax', shortName: 'Ajax', competitionId: 'eredivisie' },
  { id: 'psv', name: 'PSV', shortName: 'PSV', competitionId: 'eredivisie' },
  { id: 'fey', name: 'Feyenoord', shortName: 'Feyenoord', competitionId: 'eredivisie' },
  { id: 'aza', name: 'AZ Alkmaar', shortName: 'AZ', competitionId: 'eredivisie' },
  { id: 'utr', name: 'FC Utrecht', shortName: 'Utrecht', competitionId: 'eredivisie' },
  { id: 'twe', name: 'FC Twente', shortName: 'Twente', competitionId: 'eredivisie' },
  { id: 'hee', name: 'sc Heerenveen', shortName: 'Heerenveen', competitionId: 'eredivisie' },
  { id: 'vit', name: 'Vitesse', shortName: 'Vitesse', competitionId: 'eredivisie' },
  { id: 'gro', name: 'FC Groningen', shortName: 'Groningen', competitionId: 'eredivisie' },
  { id: 'spa', name: 'Sparta Rotterdam', shortName: 'Sparta', competitionId: 'eredivisie' },
  { id: 'nec', name: 'NEC Nijmegen', shortName: 'NEC', competitionId: 'eredivisie' },
  { id: 'gae', name: 'Go Ahead Eagles', shortName: 'Go Ahead', competitionId: 'eredivisie' },
  { id: 'emm', name: 'FC Emmen', shortName: 'Emmen', competitionId: 'eredivisie' },
  { id: 'for', name: 'Fortuna Sittard', shortName: 'Fortuna', competitionId: 'eredivisie' },
  { id: 'zwl', name: 'PEC Zwolle', shortName: 'PEC', competitionId: 'eredivisie' },
  { id: 'rkc', name: 'RKC Waalwijk', shortName: 'RKC', competitionId: 'eredivisie' },
  { id: 'camb', name: 'SC Cambuur', shortName: 'Cambuur', competitionId: 'eredivisie' },
  { id: 'hera', name: 'Heracles Almelo', shortName: 'Heracles', competitionId: 'eredivisie' },
  { id: 'wlm', name: 'Willem II', shortName: 'Willem II', competitionId: 'eredivisie' },
  { id: 'ado', name: 'ADO Den Haag', shortName: 'ADO', competitionId: 'eredivisie' },
  { id: 'vvv', name: 'VVV-Venlo', shortName: 'VVV', competitionId: 'eredivisie' },
  { id: 'exc', name: 'Excelsior', shortName: 'Excelsior', competitionId: 'eredivisie' },
  { id: 'vold', name: 'FC Volendam', shortName: 'Volendam', competitionId: 'eredivisie' },
  // Primeira Liga
  { id: 'benf', name: 'Benfica', shortName: 'Benfica', competitionId: 'primeira' },
  { id: 'ptm', name: 'FC Porto', shortName: 'Porto', competitionId: 'primeira' },
  { id: 'scp', name: 'Sporting CP', shortName: 'Sporting', competitionId: 'primeira' },
  { id: 'brag', name: 'SC Braga', shortName: 'Braga', competitionId: 'primeira' },
  { id: 'vsc', name: 'Vitória SC', shortName: 'Vitória SC', competitionId: 'primeira' },
  { id: 'boav', name: 'Boavista', shortName: 'Boavista', competitionId: 'primeira' },
  { id: 'fama', name: 'Famalicão', shortName: 'Famalicão', competitionId: 'primeira' },
  { id: 'scla', name: 'Santa Clara', shortName: 'Santa Clara', competitionId: 'primeira' },
  { id: 'gilv', name: 'Gil Vicente', shortName: 'Gil Vicente', competitionId: 'primeira' },
  { id: 'more', name: 'Moreirense', shortName: 'Moreirense', competitionId: 'primeira' },
  { id: 'esto', name: 'Estoril Praia', shortName: 'Estoril', competitionId: 'primeira' },
  { id: 'port', name: 'Portimonense', shortName: 'Portimonense', competitionId: 'primeira' },
  { id: 'tond', name: 'Tondela', shortName: 'Tondela', competitionId: 'primeira' },
  { id: 'mart', name: 'Marítimo', shortName: 'Marítimo', competitionId: 'primeira' },
  { id: 'bsad', name: 'Belenenses SAD', shortName: 'B-SAD', competitionId: 'primeira' },
  { id: 'arou', name: 'Arouca', shortName: 'Arouca', competitionId: 'primeira' },
  { id: 'cpia', name: 'Casa Pia', shortName: 'Casa Pia', competitionId: 'primeira' },
  { id: 'chav', name: 'Chaves', shortName: 'Chaves', competitionId: 'primeira' },
  { id: 'pfer', name: 'Paços de Ferreira', shortName: 'P. Ferreira', competitionId: 'primeira' },
  { id: 'vset', name: 'Vitória Setúbal', shortName: 'Vit. Setúbal', competitionId: 'primeira' },
  { id: 'aves', name: 'CD Aves', shortName: 'Aves', competitionId: 'primeira' },
  { id: 'faren', name: 'Farense', shortName: 'Farense', competitionId: 'primeira' },
  { id: 'nac', name: 'Nacional da Madeira', shortName: 'Nacional', competitionId: 'primeira' },
  { id: 'viz', name: 'FC Vizela', shortName: 'Vizela', competitionId: 'primeira' },
  // Scottish Premiership
  { id: 'celt', name: 'Celtic', shortName: 'Celtic', competitionId: 'spl' },
  { id: 'rang', name: 'Rangers', shortName: 'Rangers', competitionId: 'spl' },
  { id: 'aber', name: 'Aberdeen', shortName: 'Aberdeen', competitionId: 'spl' },
  { id: 'hibs', name: 'Hibernian', shortName: 'Hibs', competitionId: 'spl' },
  { id: 'kilm', name: 'Kilmarnock', shortName: 'Killie', competitionId: 'spl' },
  { id: 'livi', name: 'Livingston', shortName: 'Livi', competitionId: 'spl' },
  { id: 'moth', name: 'Motherwell', shortName: 'Motherwell', competitionId: 'spl' },
  { id: 'ross', name: 'Ross County', shortName: 'Ross County', competitionId: 'spl' },
  { id: 'stj', name: 'St. Johnstone', shortName: 'St. Johnstone', competitionId: 'spl' },
  { id: 'stm', name: 'St. Mirren', shortName: 'St. Mirren', competitionId: 'spl' },
  { id: 'hrt', name: 'Hearts', shortName: 'Hearts', competitionId: 'spl' },
  { id: 'dund', name: 'Dundee United', shortName: 'Dundee Utd', competitionId: 'spl' },
  { id: 'dun', name: 'Dundee', shortName: 'Dundee', competitionId: 'spl' },
  { id: 'hami', name: 'Hamilton', shortName: 'Hamilton', competitionId: 'spl' },
  // Turkish Super Lig
  { id: 'gala', name: 'Galatasaray', shortName: 'Galatasaray', competitionId: 'superlig' },
  { id: 'fene', name: 'Fenerbahçe', shortName: 'Fenerbahçe', competitionId: 'superlig' },
  { id: 'besi', name: 'Beşiktaş', shortName: 'Beşiktaş', competitionId: 'superlig' },
  { id: 'trab', name: 'Trabzonspor', shortName: 'Trabzon', competitionId: 'superlig' },
  { id: 'basa', name: 'Başakşehir FK', shortName: 'Başakşehir', competitionId: 'superlig' },
  { id: 'alan', name: 'Alanyaspor', shortName: 'Alanya', competitionId: 'superlig' },
  { id: 'antl', name: 'Antalyaspor', shortName: 'Antalya', competitionId: 'superlig' },
  { id: 'gazt', name: 'Gaziantep FK', shortName: 'Gaziantep', competitionId: 'superlig' },
  { id: 'kasim', name: 'Kasımpaşa', shortName: 'Kasımpaşa', competitionId: 'superlig' },
  { id: 'kay', name: 'Kayserispor', shortName: 'Kayseri', competitionId: 'superlig' },
  { id: 'kon', name: 'Konyaspor', shortName: 'Konya', competitionId: 'superlig' },
  { id: 'siv', name: 'Sivasspor', shortName: 'Sivas', competitionId: 'superlig' },
  { id: 'ank', name: 'Ankaragücü', shortName: 'Ankaragücü', competitionId: 'superlig' },
  { id: 'gozt', name: 'Göztepe', shortName: 'Göztepe', competitionId: 'superlig' },
  { id: 'riz', name: 'Rizespor', shortName: 'Rize', competitionId: 'superlig' },
  { id: 'deni', name: 'Denizlispor', shortName: 'Denizli', competitionId: 'superlig' },
  { id: 'gencl', name: 'Gençlerbirliği', shortName: 'Gençler', competitionId: 'superlig' },
  { id: 'yenim', name: 'Yeni Malatyaspor', shortName: 'Malatyaspor', competitionId: 'superlig' },
  { id: 'hatay', name: 'Hatayspor', shortName: 'Hatay', competitionId: 'superlig' },
  { id: 'fatih', name: 'Fatih Karagümrük', shortName: 'Karagümrük', competitionId: 'superlig' },
  { id: 'adan', name: 'Adana Demirspor', shortName: 'Adana D.S.', competitionId: 'superlig' },
  { id: 'gir', name: 'Giresunspor', shortName: 'Giresun', competitionId: 'superlig' },
  { id: 'umr', name: 'Ümraniyespor', shortName: 'Ümraniye', competitionId: 'superlig' },
  { id: 'ist', name: 'İstanbulspor', shortName: 'İstanbul', competitionId: 'superlig' },
  { id: 'erzu', name: 'Erzurumspor', shortName: 'Erzurum', competitionId: 'superlig' },
  // Greek Super League
  { id: 'olyp', name: 'Olympiacos', shortName: 'Olympiacos', competitionId: 'gsl' },
  { id: 'paok', name: 'PAOK', shortName: 'PAOK', competitionId: 'gsl' },
  { id: 'aek', name: 'AEK', shortName: 'AEK', competitionId: 'gsl' },
  { id: 'pana', name: 'Panathinaikos', shortName: 'Pana', competitionId: 'gsl' },
  { id: 'aris', name: 'Aris', shortName: 'Aris', competitionId: 'gsl' },
  { id: 'atr', name: 'Atromitos', shortName: 'Atromitos', competitionId: 'gsl' },
  { id: 'astr', name: 'Asteras Tripolis', shortName: 'Asteras', competitionId: 'gsl' },
  { id: 'lam', name: 'Lamia', shortName: 'Lamia', competitionId: 'gsl' },
  { id: 'ofi', name: 'OFI', shortName: 'OFI', competitionId: 'gsl' },
  { id: 'vols', name: 'Volos', shortName: 'Volos', competitionId: 'gsl' },
  { id: 'pasg', name: 'PAS Giannina', shortName: 'PAS', competitionId: 'gsl' },
  { id: 'panet', name: 'Panetolikos', shortName: 'Panetolikos', competitionId: 'gsl' },
  { id: 'ion', name: 'Ionikos', shortName: 'Ionikos', competitionId: 'gsl' },
  { id: 'leva', name: 'Levadeiakos', shortName: 'Levadeiakos', competitionId: 'gsl' },
  { id: 'apol', name: 'Apollon Smyrnis', shortName: 'Apollon', competitionId: 'gsl' },
  { id: 'lar', name: 'AEL Larisa', shortName: 'Larisa', competitionId: 'gsl' },
  { id: 'pani', name: 'Panionios', shortName: 'Panionios', competitionId: 'gsl' },
  { id: 'xant', name: 'Xanthi', shortName: 'Xanthi', competitionId: 'gsl' },
];
...
const CLUB_ALIAS_BY_COMP = {
  ...
  // Eredivisie aliases
  'eredivisie|ajax': 'ajx', 'eredivisie|psv': 'psv', 'eredivisie|psv eindhoven': 'psv',
  'eredivisie|feyenoord': 'fey', 'eredivisie|az': 'aza', 'eredivisie|az alkmaar': 'aza',
  'eredivisie|fc utrecht': 'utr', 'eredivisie|utrecht': 'utr',
  'eredivisie|fc twente': 'twe', 'eredivisie|twente': 'twe',
  'eredivisie|sc heerenveen': 'hee', 'eredivisie|heerenveen': 'hee',
  'eredivisie|vitesse': 'vit',
  'eredivisie|fc groningen': 'gro', 'eredivisie|groningen': 'gro',
  'eredivisie|sparta rotterdam': 'spa', 'eredivisie|sparta': 'spa',
  'eredivisie|nec': 'nec', 'eredivisie|nec nijmegen': 'nec', 'eredivisie|n.e.c. nijmegen': 'nec',
  'eredivisie|n.e.c.': 'nec',
  'eredivisie|go ahead eagles': 'gae', 'eredivisie|go ahead': 'gae',
  'eredivisie|fc emmen': 'emm', 'eredivisie|emmen': 'emm',
  'eredivisie|fortuna sittard': 'for', 'eredivisie|fortuna': 'for',
  'eredivisie|pec zwolle': 'zwl', 'eredivisie|pec': 'zwl',
  'eredivisie|rkc waalwijk': 'rkc', 'eredivisie|rkc': 'rkc',
  'eredivisie|sc cambuur': 'camb', 'eredivisie|cambuur': 'camb',
  'eredivisie|heracles almelo': 'hera', 'eredivisie|heracles': 'hera',
  'eredivisie|willem ii': 'wlm',
  'eredivisie|ado den haag': 'ado', 'eredivisie|ado': 'ado',
  'eredivisie|vvv-venlo': 'vvv', 'eredivisie|vvv': 'vvv', 'eredivisie|vvv venlo': 'vvv',
  'eredivisie|excelsior': 'exc', 'eredivisie|sbv excelsior': 'exc',
  'eredivisie|fc volendam': 'vold', 'eredivisie|volendam': 'vold',
  // Primeira Liga aliases (including fm2023 short codes BRG/BVT/MRT/PTM/VIZ/VTSC)
  'primeira|benfica': 'benf', 'primeira|slb': 'benf', 'primeira|sport lisboa e benfica': 'benf',
  'primeira|fc porto': 'ptm', 'primeira|porto': 'ptm', 'primeira|fcp': 'ptm', 'primeira|ptm': 'ptm',
  'primeira|sporting cp': 'scp', 'primeira|sporting': 'scp', 'primeira|sporting clube de portugal': 'scp',
  'primeira|sc braga': 'brag', 'primeira|braga': 'brag', 'primeira|brg': 'brag', 'primeira|sporting clube de braga': 'brag',
  'primeira|vitória sc': 'vsc', 'primeira|vit. guimarães': 'vsc', 'primeira|vit. guimaraes': 'vsc',
  'primeira|vitória guimarães': 'vsc', 'primeira|vitoria guimaraes': 'vsc', 'primeira|vtsc': 'vsc',
  'primeira|vitória sport clube': 'vsc',
  'primeira|boavista': 'boav', 'primeira|boavista fc': 'boav', 'primeira|bvt': 'boav',
  'primeira|famalicão': 'fama', 'primeira|famalicao': 'fama', 'primeira|fc famalicão': 'fama',
  'primeira|santa clara': 'scla',
  'primeira|gil vicente': 'gilv', 'primeira|gil vicente fc': 'gilv',
  'primeira|moreirense': 'more', 'primeira|moreirense fc': 'more',
  'primeira|estoril praia': 'esto', 'primeira|estoril': 'esto',
  'primeira|portimonense': 'port', 'primeira|portimonense sc': 'port',
  'primeira|tondela': 'tond', 'primeira|clube desportivo de tondela': 'tond',
  'primeira|marítimo': 'mart', 'primeira|maritimo': 'mart', 'primeira|cs marítimo': 'mart', 'primeira|mrt': 'mart',
  'primeira|belenenses sad': 'bsad', 'primeira|b-sad': 'bsad', 'primeira|belenenses': 'bsad',
  'primeira|arouca': 'arou', 'primeira|fc arouca': 'arou',
  'primeira|casa pia': 'cpia', 'primeira|casa pia ac': 'cpia',
  'primeira|chaves': 'chav', 'primeira|gd chaves': 'chav',
  'primeira|p. ferreira': 'pfer', 'primeira|paços de ferreira': 'pfer', 'primeira|pacos de ferreira': 'pfer',
  'primeira|vitória setúbal': 'vset', 'primeira|vit. setúbal': 'vset', 'primeira|vitoria setubal': 'vset',
  'primeira|aves': 'aves', 'primeira|cd aves': 'aves', 'primeira|desportivo das aves': 'aves',
  'primeira|farense': 'faren', 'primeira|sc farense': 'faren',
  'primeira|nacional da madeira': 'nac', 'primeira|nacional': 'nac', 'primeira|cd nacional': 'nac',
  'primeira|fc vizela': 'viz', 'primeira|vizela': 'viz', 'primeira|viz': 'viz',
  // Scottish Premiership aliases
  'spl|celtic': 'celt', 'spl|celtic fc': 'celt',
  'spl|rangers': 'rang', 'spl|rangers fc': 'rang',
  'spl|aberdeen': 'aber', 'spl|aberdeen fc': 'aber',
  'spl|hibernian': 'hibs', 'spl|hibs': 'hibs', 'spl|hibernian fc': 'hibs',
  'spl|kilmarnock': 'kilm', 'spl|kilmarnock fc': 'kilm',
  'spl|livingston': 'livi', 'spl|livingston fc': 'livi',
  'spl|motherwell': 'moth', 'spl|motherwell fc': 'moth',
  'spl|ross county': 'ross', 'spl|ross county fc': 'ross',
  'spl|st. johnstone': 'stj', 'spl|st johnstone': 'stj',
  'spl|st. mirren': 'stm', 'spl|st mirren': 'stm',
  'spl|hearts': 'hrt', 'spl|heart of midlothian': 'hrt',
  'spl|dundee utd': 'dund', 'spl|dundee united': 'dund', 'spl|dundee utd fc': 'dund',
  'spl|dundee': 'dun', 'spl|dundee fc': 'dun',
  'spl|hamilton': 'hami', 'spl|hamilton academical': 'hami', 'spl|hamilton academicals': 'hami',
  // Turkish Super Lig aliases
  'superlig|galatasaray': 'gala', 'superlig|galatasaray sk': 'gala',
  'superlig|fenerbahçe': 'fene', 'superlig|fenerbahce': 'fene', 'superlig|fenerbahçe sk': 'fene',
  'superlig|beşiktaş': 'besi', 'superlig|besiktas': 'besi', 'superlig|beşiktaş jk': 'besi',
  'superlig|trabzonspor': 'trab',
  'superlig|başakşehir fk': 'basa', 'superlig|başakşehir': 'basa', 'superlig|basaksehir fk': 'basa',
  'superlig|basaksehir': 'basa', 'superlig|mediopol basakşehir fk': 'basa',
  'superlig|alanyaspor': 'alan', 'superlig|ala anyaspor': 'alan',
  'superlig|antalyaspor': 'antl',
  'superlig|gaziantep fk': 'gazt', 'superlig|gaziantep': 'gazt',
  'superlig|kasımpaşa': 'kasim', 'superlig|kasimpasa': 'kasim', 'superlig|kasımpaşa sk': 'kasim',
  'superlig|kayserispor': 'kay',
  'superlig|konyaspor': 'kon',
  'superlig|sivasspor': 'siv',
  'superlig|ankaragücü': 'ank', 'superlig|ankaragucu': 'ank', 'superlig|mke ankaragücü': 'ank',
  'superlig|göztepe': 'gozt', 'superlig|goztepe': 'gozt', 'superlig|göztepe sk': 'gozt',
  'superlig|rizespor': 'riz', 'superlig|çaykur rizespor': 'riz', 'superlig|caykur rizespor': 'riz',
  'superlig|denizlispor': 'deni',
  'superlig|gençlerbirliği': 'gencl', 'superlig|genclerbirligi': 'gencl',
  'superlig|yeni malatyaspor': 'yenim', 'superlig|yeni malatya': 'yenim',
  'superlig|hatayspor': 'hatay', 'superlig|hatay spor': 'hatay',
  'superlig|fatih karagümrük': 'fatih', 'superlig|fatih karagumruk': 'fatih',
  'superlig|f. karagümrük': 'fatih', 'superlig|f. karagumruk': 'fatih',
  'superlig|adana d.s.': 'adan', 'superlig|adana ds': 'adan', 'superlig|adana demirspor': 'adan',
  'superlig|giresunspor': 'gir',
  'superlig|ümraniyespor': 'umr', 'superlig|umraniyespor': 'umr',
  'superlig|i̇stanbulspor': 'ist', 'superlig|istanbulspor': 'ist', 'superlig|istanbulspor a.ş': 'ist',
  'superlig|bld. erzurumspor': 'erzu', 'superlig|bb erzurumspor': 'erzu', 'superlig|erzurumspor': 'erzu',
  // Greek Super League aliases
  'gsl|olympiacos': 'olyp', 'gsl|olympiakos': 'olyp', 'gsl|olympiacos cfp': 'olyp', 'gsl|olympiacos sfptp': 'olyp',
  'gsl|paok': 'paok', 'gsl|paok fc': 'paok',
  'gsl|aek': 'aek', 'gsl|aek athens': 'aek', 'gsl|aek athens fc': 'aek',
  'gsl|panathinaikos': 'pana', 'gsl|panathinaikos fc': 'pana', 'gsl|pao': 'pana',
  'gsl|aris': 'aris', 'gsl|aris fc': 'aris',
  'gsl|atromitos': 'atr', 'gsl|atromitos fc': 'atr', 'gsl|atromitos athens': 'atr',
  'gsl|asteras tripolis': 'astr', 'gsl|ast. tripolis': 'astr', 'gsl|asteras tripolis fc': 'astr',
  'gsl|lamia': 'lam', 'gsl|pas lamia 1964': 'lam',
  'gsl|ofi': 'ofi', 'gsl|ofi crete': 'ofi', 'gsl|ofi fc': 'ofi',
  'gsl|volos': 'vols', 'gsl|volos fc': 'vols', 'gsl|volos nfc': 'vols',
  'gsl|pas giannina': 'pasg', 'gsl|pas': 'pasg', 'gsl|pas giannina fc': 'pasg',
  'gsl|panetolikos': 'panet', 'gsl|panaitolikos': 'panet', 'gsl|panetolikos fc': 'panet',
  'gsl|ionikos': 'ion', 'gsl|ionikos fc': 'ion',
  'gsl|levadeiakos': 'leva', 'gsl|levadiakos': 'leva', 'gsl|ao levadeiakos': 'leva',
  'gsl|apollon': 'apol', 'gsl|apollon smyrnis': 'apol', 'gsl|apollon smyrni': 'apol',
  'gsl|larisa': 'lar', 'gsl|ael larisa': 'lar', 'gsl|ael': 'lar', 'gsl|ael fc': 'lar',
  'gsl|panionios': 'pani', 'gsl|panionios fc': 'pani',
  'gsl|xanthi': 'xant', 'gsl|ao xanthi': 'xant', 'gsl|skoda xanthi': 'xant',
};
...
function mapDivision(division) {
  ...
  if (d === 'Eredivisie' || d === 'Dutch Eredivisie') return 'eredivisie';
  if (d === 'Portuguese Premier League' || d === 'Portuguese Liga' || d.includes('Liga Portugal')) return 'primeira';
  if (d === 'Scottish Premiership' || d === 'cinch Premiership' || d === 'Ladbrokes Premiership') return 'spl';
  if (d.includes('Süper Lig') || d === 'Turkish Super League' || d.includes('Spor Toto Süper Lig')) return 'superlig';
  if (d === 'Greek Super League' || d === 'Greek Super League 1' || d === 'Super League Interwetten') return 'gsl';
  return null;
}
